...
if any(re.search(p, prompt, flags=re.IGNORECASE) for p in PATTERNS):
    print(
        ...
        "반드시 도구로 직접 읽어야 합니다:\n"
        "  - 스킬 목록: Glob 'C:/Users/yoone/.claude/skills/*'\n"
        "  - 스킬 본문: 'C:/Users/yoone/.claude/skills/<name>/SKILL.md' Read 또는 Grep\n"
        "  - 에이전트 목록: Glob 'C:/Users/yoone/Dropbox/ClaudeFile/Congregation/.claude/agents/*.md'\n"
        "  - 훅·권한 설정: 'C:/Users/yoone/Dropbox/ClaudeFile/Congregation/.claude/settings.json' Read\n"
